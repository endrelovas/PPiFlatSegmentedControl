...
//    
    ...
    PPiFlatSegmentedControl *segmentControl = [[PPiFlatSegmentedControl alloc] initWithFrame:CGRectMake(20, 200, 250, 30)
                                                              items:@[[[PPiFlatSegmentItem alloc] initWithTitle:NSLocalizedString(@"Friends", nil) andIcon:@"icon-twitter"], [[PPiFlatSegmentItem alloc] initWithTitle:NSLocalizedString(@"Everyone", nil) andIcon:nil]]
